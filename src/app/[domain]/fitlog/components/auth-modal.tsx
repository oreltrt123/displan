    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <Card className="w-full max-w-md relative">
        ...
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">{isSignUp ? "Create Account" : "Sign In to FitLog"}</CardTitle>
          <CardDescription>
            {isSignUp ? "Create an account to track your fitness journey" : "Sign in to save your fitness progress"}
          </CardDescription>
        </CardHeader>
