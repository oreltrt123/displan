        ...
        <div className="w-full max-w-md rounded-lg border border-border bg-card p-6 shadow-sm">
          <form className="flex flex-col space-y-6" action={signUpAction}>
            <div className="space-y-2 text-center">
              <h1 className="text-3xl font-semibold tracking-tight" data-i18n="signUp">
                Sign up
              </h1>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="full_name" className="text-sm font-medium" data-i18n="fullName">
                  Full Name
                </Label>
            ...
            <SubmitButton pendingText="Signing up..." className="w-full" data-i18n="signUp">
              Sign up
            </SubmitButton>
