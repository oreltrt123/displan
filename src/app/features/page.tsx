    ...
    <div className="w-full min-h-screen text-white bg-background relative">
      ...
      <main className="flex flex-col gap-20 items-center pt-32 pb-20">
        ...
        <section className="px-6 py-0 mx-auto my-0 text-center max-w-[900px]">
          ...
          <p
            className="mb-10 text-xl md:text-2xl leading-8 text-center max-w-[700px] mx-auto text-white text-opacity-60 relative"
          ...
          >
            ...
            {showInfo && (
              <div
                ref={infoRef}
                className="absolute left-1/2 transform -translate-x-1/2 mt-4 bg-gray-100 text-gray-700 p-4 rounded-lg max-w-md mx-auto text-sm z-50 shadow-lg"
        ...
        <section className="w-full max-w-7xl px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="zeroCommissionsDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="builtInEscrowDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="globalTeamCollaborationDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="instantDigitalStorefrontDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="qualityAssuranceToolsDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="communitySupportDonationsDesc">
        ...
        {/* Creator Tools Grid */}
        <section className="w-full max-w-7xl px-6 mx-auto bg-white/[0.02] py-20 rounded-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="customBrandingDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="analyticsDashboardDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="licensingRightsDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="fileDeliveryDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              <div className="w-12 h-12 bg-pink-500/20 rounded-xl flex items-center justify-center mb-6">
                <FileVersion className="w-6 h-6 text-pink-500" />
              </div>
              <h3 className="text-xl font-semibold mb-4" data-i18n="versionUpdates">
                Version Updates
              </h3>
              <p className="text-white/60" data-i18n="versionUpdatesDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="privateBetaDesc">
        ...
        <section className="w-full max-w-7xl px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="partnerFinderDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="projectMilestonesDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="feedbackBoardsDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="builtInMessagingDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="taskAssignmentsDesc">
        ...
        <section className="w-full max-w-7xl px-6 mx-auto bg-black/95 py-20 rounded-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="escrowProtectionDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="disputeResolutionDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="secureCheckoutDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="gdprPrivacyDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/60" data-i18n="openSourceDesc">
        ...
        <section className="w-full max-w-7xl px-6 mx-auto">
          ...
          <p className="text-xl text-white/60 text-center mb-10 max-w-[700px] mx-auto" data-i18n="stayFreeForever">
            Stay Free Forever, or Upgrade When You Want
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors border border-yellow-500/20">
              ...
              <p className="text-white/60 text-sm" data-i18n="boostedListingsDesc">
            ...
            <div className="p-6 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors border border-yellow-500/20">
              ...
              <p className="text-white/60 text-sm" data-i18n="customDomainsDesc">
            ...
            <div className="p-6 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors border border-yellow-500/20">
              ...
              <p className="text-white/60 text-sm" data-i18n="prioritySupportDesc">
        ...
        <section className="w-full max-w-4xl px-6 mx-auto text-center">
          ...
          <p className="text-xl text-white/60 mb-10 max-w-[700px] mx-auto" data-i18n="joinThousands">
