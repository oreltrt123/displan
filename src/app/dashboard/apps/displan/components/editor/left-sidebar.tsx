    ...
    <>
      ...
      >
        ...
        <div className="w-12 sdadwdsdawdsd flex flex-col py-4">
          <div className=" border-r border-gray-200 dark:border-gray-800"></div>
          <button
            onClick={() => setActiveTab("pages")}
            className={`w-10 h-10 mx-1 mb-2 rounded-lg flex items-center justify-center transition-colors ${
              activeTab === "pages"
          ...
          <div className="p-4 h-full flex flex-col">
            <div className="flex-1 overflow-hidden">
              {activeTab === "pages" ? (
                <>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="w-8 h-8 bg-[#8888881A] rounded-lg text-center hover:bg-[#8888881A]  flex items-center justify-center transition-colors"
                    >
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Elements</h2>
                  <ElementsPanel onAddElement={onAddElement} />
                </div>
              ) : (
                // AI Panel
                <div>
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">AI Assistant</h2>
