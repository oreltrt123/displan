  ...
  return (
    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-50">
      ...
      >
        ...
        >
          <svg
            className={`w-4 h-4 ${currentTheme ? "text-white" : "text-black"}`}
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" role="presentation">
            <path d="M10 2a8 8 0 0 1 0 16H4a2 2 0 0 1-2-2v-6a8 8 0 0 1 8-8Z " fill="currentColor"></path>
          </svg>
        </button>
        ...
        <button
          ...
          className={`p-2 rounded ${currentTheme ? "hover:bg-[#8888881A]" : "hover:bg-[#8888881A]"}`}
