    ...
    <div className="w-full min-h-screen text-white bg-black relative">
      ...
      <main className="flex flex-col gap-16 items-center pt-32 pb-20">
        ...
        <section className="px-6 py-0 mx-auto my-0 text-center max-w-[900px]">
          ...
          <p
            className="mb-10 text-xl leading-8 text-center max-w-[700px] mx-auto text-white text-opacity-60"
        ...
        <section className="w-full max-w-5xl px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/8 transition-colors">
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-blue-500/20 rounded-xl flex items-center justify-center mr-4">
                  <LayoutKanban className="w-5 h-5 text-blue-500" />
                </div>
                <h3 className="text-xl font-semibold" data-i18n="taskBoards">
                  Task Boards
                </h3>
              </div>
              <p className="text-white/60" data-i18n="taskBoardsDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/8 transition-colors">
              ...
              <p className="text-white/60" data-i18n="milestonePaymentsDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/8 transition-colors">
              ...
              <p className="text-white/60" data-i18n="privatePublicProjectsDesc">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/8 transition-colors">
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-pink-500/20 rounded-xl flex items-center justify-center mr-4">
            ...
            <div className="p-8 rounded-2xl bg-white/5 hover:bg-white/8 transition-colors">
              ...
              <p className="text-white/60" data-i18n="launchToStorefrontDesc">
        ...
        <section className="w-full max-w-3xl px-6 mx-auto">
          <div className="p-10 rounded-3xl bg-white/5 text-center">
            <h2 className="text-3xl font-semibold mb-6" data-i18n="wantEarlyAccess">
              Want Early Access?
            </h2>
            <p className="text-xl text-white/80 mb-8" data-i18n="signUpToday">
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    className="flex-1 px-4 py-3 rounded-full bg-white/10 border border-white/20 text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value={email}
                  ...
                  <button
                    type="submit"
                    className="px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-full font-medium flex items-center justify-center transition-colors"
                    disabled={loading}
              ...
              <div className="bg-green-500/20 text-green-300 p-4 rounded-xl max-w-md mx-auto" data-i18n="thanksNotify">
            ...
            <div className="mt-8">
              <Link
                href="/features"
                className="px-6 py-3 border border-white hover:bg-white/10 rounded-full font-medium inline-flex items-center transition-colors"
        ...
        <section className="w-full max-w-4xl px-6 mx-auto">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 top-0 bottom-0 w-1 bg-white/20"></div>
              ...
              <div className="relative flex flex-col md:flex-row items-center md:items-start">
                <div className="order-1 md:w-1/2 md:pr-8 md:text-right mb-4 md:mb-0">
                  <div className="p-6 rounded-2xl bg-white/5">
                    ...
                    <p className="text-white/60" data-i18n="planningPhaseDesc">
                      Designing the architecture and user experience
                    </p>
                  </div>
                </div>
                <div className="z-10 flex items-center order-0 md:order-1 bg-blue-500 rounded-full w-8 h-8 md:mx-auto">
              ...
              <div className="relative flex flex-col md:flex-row items-center md:items-start">
                <div className="order-1 md:order-2 md:w-1/2 md:pl-8 mb-4 md:mb-0">
                  <div className="p-6 rounded-2xl bg-white/5">
                    ...
                    <p className="text-white/60" data-i18n="developmentDesc">
                      Building core functionality and features
                    </p>
                  </div>
                </div>
                <div className="z-10 flex items-center order-0 bg-blue-500 rounded-full w-8 h-8 md:mx-auto">
              ...
              <div className="relative flex flex-col md:flex-row items-center md:items-start">
                <div className="order-1 md:w-1/2 md:pr-8 md:text-right mb-4 md:mb-0">
                  <div className="p-6 rounded-2xl bg-white/5">
                    ...
                    <p className="text-white/60" data-i18n="betaTestingDesc">
                      Limited release to early access users
                    </p>
                  </div>
                </div>
                <div className="z-10 flex items-center order-0 md:order-1 border-2 border-white/40 bg-transparent rounded-full w-8 h-8 md:mx-auto"></div>
                <div className="order-2 md:w-1/2 md:pl-8 hidden md:block"></div>
              </div>
              ...
              <div className="relative flex flex-col md:flex-row items-center md:items-start">
                <div className="order-1 md:order-2 md:w-1/2 md:pl-8 mb-4 md:mb-0">
                  <div className="p-6 rounded-2xl bg-white/5">
                    ...
                    <p className="text-white/60" data-i18n="publicLaunchDesc">
                      Full release of Projects to all DisPlan users
                    </p>
                  </div>
                </div>
                <div className="z-10 flex items-center order-0 border-2 border-white/40 bg-transparent rounded-full w-8 h-8 md:mx-auto"></div>
                <div className="order-2 md:order-1 md:w-1/2 md:pr-8 md:text-right hidden md:block"></div>
              </div>
            </div>
          </div>
