...
import "@/app/dashboard/apps/styles/apps.css"
      ...
      <main className="w-full">
        <div className="container mx-auto px-4 py-8 flex flex-col gap-8">
          ...
          <header className="flex flex-col gap-4">
            <Link href={'/dashboard/apps'}><h1 className="text-black dark:text-white font-bold tracking-tighter asfasfafgwg">Apps</h1></Link>
          </header>
